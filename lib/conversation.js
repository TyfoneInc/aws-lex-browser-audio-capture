(function() {
  ...
  exports.conversation = function(config, onStateChange, onSuccess, onError, onAudioData) {
    ...
    var creds = new AWS.CognitoIdentityCredentials({
      IdentityPoolId: 'us-east-1:8a42e098-8c93-4101-877e-0b7682b699c2'
    });
    AWS.config.update({
      region: 'us-east-1',
      credentials: creds
  ...
  var applyDefaults = function(config) {
    ...
    lexConfig.botName = lexConfig.hasOwnProperty('botName') ? lexConfig.botName : 'nFinia';
